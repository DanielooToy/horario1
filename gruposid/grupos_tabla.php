...
$grupos_query = "SELECT id, grado, grupo, 
    CASE 
...
<body>
    ...
    <nav id="nav">
        <ul style="list-style-type: none; margin: 0; padding: 0; overflow: hidden; background-color: #2f2c79;">
            ...
            <li style="float: left;"><a href="grupos_tabla.php" style="display: block; color: white; text-align: center; padding: 14px 16px; text-decoration: none;">Agregar Grupos</a></li>
    ...
    <div class="search-container">
        ...
        <input type="text" id="search" onkeyup="searchGrupos()" placeholder="Ingrese el nombre del grupo">
    </div>

    <a href="agregar_grupos.php" button id="btn-nuevo-usuario">Nuevo Grupo</a>
    <br>
    <p></p>
    <br>
    ...
    <table border="1" id="grupos-table">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($grupos_result)) {
                ...
                echo "<td>";
                echo "<a class='btn btn-eliminar' href='eliminar_grupos.php?id=" . $row['id'] . "'>Eliminar</a>";
                echo "<a class='btn btn-editar' href='editar_grupos.php?id=" . $row['id'] . "'>Editar</a>";
    ...
    <script>
        function searchGrupos() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[2]; // Cambia 2 por la columna donde se encuentra el nombre del grupo
                if (td) {
