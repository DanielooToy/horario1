    ...
    if (isset($_POST['tabla_id'], $_POST['hora_inicio'], $_POST['hora_fin'], $_POST['lunes'], $_POST['martes'], $_POST['miercoles'], $_POST['jueves'], $_POST['viernes'])) {
        ...
        for ($i = 0; $i < count($horas_inicio); $i++) {
            ...
            if ($stmt_check->fetch()) {
                ...
                header("Location: tics_horario.php?error=" . urlencode("Error: Ya existe una materia con el mismo nombre y la misma hora de inicio."));
                exit;
            }
        ...
        if($success) {
            ...
            header("Location: tics_horario.php?success=true");
            exit;
        }
    }
}
...
<div class="container">
    ...
    <img src="../images/tics.png" style="width:200px; float:right; margin-right: 100px">
    <form method="POST">
        <div class="form-row">
