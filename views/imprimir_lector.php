...
document.getElementById('pdfButton').addEventListener('click', function() {
    ...
    style.innerHTML = `
        h1, h2, h3, h4, h5, h6, p, a, button, input, select, textarea, .no-print, .selector-label,.class-of-container { 
...
<br>
<button id='cancelButton' class="no-print" onclick="window.location.href = 'lector.php';">Cancelar</button>
</body>
</html>